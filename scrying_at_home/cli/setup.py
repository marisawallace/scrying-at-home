...
# ANSI colors — the bright variants, from the shared vocabulary (migrations,
# which run standalone, keep their own copies; see scrying_at_home/common/ansi.py).
from scrying_at_home.common.ansi import (
    BRIGHT_GREEN as GREEN,
    BRIGHT_YELLOW as YELLOW,
    BRIGHT_RED as RED,
    BRIGHT_CYAN as CYAN,
    BOLD,
    DIM,
